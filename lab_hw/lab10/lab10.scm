...
(define (teacher-hold-class teacher)
  (teacher-create(teacher-get-name teacher)(teacher-get-class teacher)(map (lambda (student)(student-attend-class student (teacher-get-class teacher)))(teacher-get-students teacher)))
  )
