...
class Player:
    def __init__(self, deck, name):
        ...
        # BEGIN Problem 2
        "*** YOUR CODE HERE ***"
        self.hand = [Deck.draw(self.deck) for i in range(5)]
        # END Problem 2
...
class AICard(Card):
    ...
    def effect(self, opponent_card, player, opponent):
        ...
        # BEGIN Problem 3
        implemented = True
        player.hand += [player.deck.draw() for i in range(2)]
        # END Problem 3
...
class TutorCard(Card):
    ...
    def effect(self, opponent_card, player, opponent):
        ...
        if player.hand:
            added = True
            player.hand += [copy(player.hand[0])]
            self.loss()
        else:
            self.loss()
        # END Problem 4
    ...
    def effect(self, opponent_card, player, opponent, arg=None):
        ...
        if player.hand:
            for i in range(len(player.hand)):
                if player.hand[i].cardtype == 'Tutor':
                    i += 1
                else:
...
class InstructorCard(Card):
    ...
    def effect(self, opponent_card, player, opponent, arg=None):
        ...
        self.defense -= 1000
        self.attack -= 1000
        if self.defense >= 0 or self.attack >= 0:
            re_add = True
